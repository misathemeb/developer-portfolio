export const aboutData = {
    ...
    description3: "Currently, I work with Python in Product Operations. I love being able to contribute to solving problems and make comprehensive SaaS products easier to use!",
    image: 1
}